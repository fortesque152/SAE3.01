...
export class ParkingController {
    constructor() {
        ...
        this.urlLondres = "../data/londres/Parking_Bays_20260109.geojson";
        this.urlMetz = "https://maps.eurometropolemetz.eu/public/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=public:pub_tsp_sta&srsName=EPSG:4326&outputFormat=application/json&cql_filter=id%20is%20not%20null";
        this.radiusMeters = 10000;
    }
    async getParkings(_user, center) {
        const parkings = [];
                ...
                if (dataMetz?.features) {
                    dataMetz.features.forEach((feature) => {
                        ...
                        if (props.place_libre !== null && props.place_libre !== undefined) {
                            parking.availableSpots = props.place_libre;
                        }
                        if (props.place_total !== null && props.place_total !== undefined) {
                            parking.totalSpots = props.place_total;
                        }
