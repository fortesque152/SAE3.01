...
export class NavigationUI {
    ...
    private instructionIcon: HTMLElement;
    private instructionText: HTMLElement;
    private instructionDistance: HTMLElement;
    private nextInstructionText: HTMLElement;
    private instructionsList: HTMLElement;
    private routeInfo: HTMLElement;
     ...
     */
    startNavigation(navigationService: NavigationService): void {
     ...
     */
    showRouteSummary(distance: number, duration: number): void {
     ...
     */
    updateDisplay(distanceToNextManeuver?: number): void {
     ...
     */
    private renderInstructionsList(): void {
        if (!this.navigationService) return;
     ...
     */
    highlightCurrentInstruction(): void {
